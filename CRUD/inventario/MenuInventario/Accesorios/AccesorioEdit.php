    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <br>
                <div class="display-4">Editar Accesorio</div>
                <br>
                <tbody>
                    <?php
                    $sql = "SELECT id_Accesorio,tipo_Accesorio,modelo_Accesorio,marca_Accesorio,serie_Accesorio FROM Accesorio WHERE id_Accesorio = $id";
                    ...
                    ?>
                        ...
                        <form class="col-md-12 col-xl-6" action="AccesorioEditResult.php" method="post">
                            <div class="form-group row col-md-12 " style="display: none;">
                                <label class="col-md-3 col-lg-1 col-xl-1 col-form-label">
                                    <h4>Id:</h4>
                                </label>
                                <div class="col-md-3 col-xl-2">
                                    <input name="id" type="text" class="form-control" readonly value="<?php echo $row['id_Accesorio'] ?>" >
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-xl-7">
                                    <input name="tipoAccesorio" type="text" class="form-control" id="inputZip" value="<?php echo $row['tipo_Accesorio'] ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 col-xl-3">
                                    <input name="marca" type="text" class="form-control" id="inputZip" value="<?php echo $row['marca_Accesorio'] ?>" required>
                                </div>
                                <label class="col-md-3 col-xl-2 col-form-label">
                                    <h4>Modelo:</h4>
                                </label>
                                <div class="col-md-3 col-xl-5">
                                    <input name="modelo" type="text" class="form-control" id="inputZip" value="<?php echo $row['modelo_Accesorio'] ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 col-xl-3">
                                    <input name="serie" type="text" class="form-control" id="inputZip" value="<?php echo $row['serie_Accesorio'] ?>" required>
                                </div>
                            </div>
                    ...
                    <?php  } ?>
                    <iframe style='display:none' id='frame' width='400' height='400' frameborder='0'>
