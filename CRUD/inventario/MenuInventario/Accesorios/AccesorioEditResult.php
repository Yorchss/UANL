...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php
            $fallo = false;
            $sql = 'UPDATE Accesorio Set tipo_Accesorio = (?) ,marca_Accesorio = (?),modelo_Accesorio = (?),serie_Accesorio = (?) Where id_Accesorio = (?)';
            $params = array($tipoAccesorio, $marca, $modelo,$serie, $id);
            ...
            if ($fallo == true) {
                echo "<script> alert('No se ha podido Actializar los datos con exito. Vuelva a intentarlo por favor.'); window.location.href='Accesorios.php'; </script>";
            } else {
                echo "<script> alert('Se han actualizado los datos de manera exitosa.'); window.location.href='Accesorios.php'; </script>";
            }
            ?>
        </div>
    </div>
